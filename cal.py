...
def main():
    ...
    total_meeting_seconds = listsum(total_duration)
    total_meeting_minutes = total_meeting_seconds / 60
    total_meeting_hours = total_meeting_minutes / 60
    total_meeting_days = total_meeting_hours / 8
    total_monthly_capacity_hours = 20 * 8
    total_monthly_capacity_days = 20
    total_monthly_events = len(events_list)

    csv_list = start + end + dur + dur_s + events_list

    print('Total Events: ', total_monthly_events)
    print(
        'Average Event Duration: ',
        float(total_meeting_hours) /
        float(total_monthly_events),
        'hours')
    print('Total Meeting Seconds: ', total_meeting_seconds, 'seconds')
    print('Total Meeting Minutes: ', total_meeting_minutes, 'minutes')
    print('Total Meeting Hours: ', total_meeting_hours, 'hours')
    print('Total Meeting Days: ', total_meeting_days, 'days')
    print(
        'Maximum Work Hours: ',
        total_monthly_capacity_hours -
        total_meeting_hours,
        'hours of working capacity')
    print(
        'Maximum Work Days: ',
        total_monthly_capacity_days -
        total_meeting_days,
